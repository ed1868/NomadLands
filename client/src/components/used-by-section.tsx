    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2
            className="text-4xl md:text-6xl font-extralight mb-8 text-white tracking-wide fade-in-luxury"
            style={{ color: "white !important" }}
          >
            Trusted by Industry Leaders
          </h2>
          <p
            className="text-lg md:text-xl text-white max-w-3xl mx-auto font-light leading-relaxed"
            style={{ color: "white !important" }}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
          <div className="text-center bg-black/20 border border-gray-800 rounded-lg p-8 backdrop-blur-sm">
            <div className="text-4xl font-extralight knight-text mb-2">
              500K+
            </div>
